...
import { View, Text, StyleSheet, SafeAreaView, Keyboard, ScrollView, Image, TouchableOpacity } from 'react-native';
...
const Otp = (props) => {
  ...
  const onPressContinue = () => {
    ...
    let params = {
      callback: () => navigation.navigate('ResetPassword', { email: props.route.params.email })
    }
      ...
      <ScrollView keyboardShouldPersistTaps='handled'>
        <View style={styles.conatiner}>
          ...
          <View style={styles.lgcontainer}>
            ...
            >
              Please enter the verification code,  that we have sent on your registered email
            </Text>
            <View style={{alignItems:'center'}} >
              <SmoothPinCodeInput
                ...
                cellSpacing={15}
                textStyle={[styles.buttonText, { fontSize: 22, color: '#3B2645' }]}
                autoFocus={true}
              />
            </View>
...
const mapDispatchToProps = (dispatch) => ({
  otpVerificationRequest: (data, navigation) => dispatch(otpVerificationRequest(data, navigation)),
});
