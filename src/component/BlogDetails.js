...
const BlogDetails = props => {
  ...
  //     if (blogDetails?.blogs) {
  //       return {__html: blogDetails?.blogs[0]?.description};
  //     }
  //   }
        ...
        <View style={styles.container}>
          ...
          <View style={styles.box}>
            <Text style={styles.title}>
              {blogDetails.blogs != undefined ? blogDetails.blogs[0].name : ''}
            </Text>
            ...
            <HTMLView
              ...
              stylesheet={[styles.subtitle, {marginBottom: 10}]}
            />
