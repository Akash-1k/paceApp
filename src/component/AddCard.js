...
const AddCard = (props) => {
    ...
    const onSave = () => {
        ...
        setIsLoading(true)
        createToken({ type: 'Card', address: { country: 'IN', }, name: 'Visa' })
            .then((result) => {
    ...
    const addCardDetails = (token) => {
        ...
        formdata.append('expiry_date', token.card.expMonth + '/' + token.card.expYear)
            ...
            <ScrollView style={styles.relative}>
                <View style={styles.container}>
                    ...
                    <CardField
                        ...
                        onCardChange={(card) => { console.log(card) }}
