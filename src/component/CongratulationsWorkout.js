...
const CongratulationsWorkout = (props) => {
    ...
    const getEarnedQuains = () => {
        ...
        formdata.append("workout_id", props.exersiseId.id);
    ...
    return (
        ...
        >
            ...
            <TouchableOpacity
                ...
                style={styles.btnn}
            >
                <Text style={{ color: "#A375EF", fontSize: 14, fontFamily: Fonts.Poppins_SemiBold }}>Explore other workouts</Text>
            </TouchableOpacity>
...
export default connect(mapStateToProps, mapDispatchToProps)(CongratulationsWorkout);
