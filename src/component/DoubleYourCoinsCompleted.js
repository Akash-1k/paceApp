...
import { Text, SafeAreaView, Image, ScrollView, StyleSheet, View, ImageBackground } from 'react-native';
                        ...
                        <ImageBackground 
                            ...
                            <View style={{marginTop:-30}}>
                                ...
                                <Text style={[styles.titlemins, 
                                    ...
                                    Running <Text style={{fontWeight:'600'}}>3 times</Text> in a week
                                </Text>
                                <Text style={[styles.titlemins, 
                                    {
                                        color:"#fff",
                                    ...
                                    Continue for <Text style={{fontWeight:'600'}}>3 times</Text> in a  row
                                </Text>
                                <Text style={[styles.titlemins, 
                                    {
                                        color:"#fff",
                                    ...
                                    Run atleast <Text style={{fontWeight:'600'}}>1 time</Text> in a week
                                </Text>
                            </View>
                        </ImageBackground>
                    </View>
