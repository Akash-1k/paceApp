...
const ThreeOptionAlert = (props) => {
    ...
    return (
        <View style={{ flex: 1, padding: 10 }} >
            ...
            <View style={{ flex: 1 }} >
                <Text style={[{ fontFamily: Fonts.Poppins_Bold, color: Colors.fontColor, fontSize: 22 }]}>{props.title}</Text>
                <Text style={[{ fontFamily: Fonts.Poppins_Medium, color: Colors.colorGray, fontSize: 20 }]}>{props.msg}</Text>
